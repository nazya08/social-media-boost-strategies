...
export const ConfigSchema = z.object({
  ...
  runtime: z.object({
    ...
    ingestAutoDisableOn402: z.boolean().default(false),
...
export const loadConfig = (): AppConfig => {
  ...
  const raw = {
    ...
    runtime: {
      ...
      ctaTextEn: process.env.CTA_TEXT_EN ?? "Tired of wasting time searching for AI tools?\n\n500+ tools. 100+ prompts.\nOrganized by niche. Ready to use.\n\n\nThe Ultimate AI Power Kit gives you everything\nyou need to work smarter with AI\n\n76% off — today only 👇",
      ...
      ingestAutoDisableOn402: boolFromEnv(process.env.INGEST_AUTO_DISABLE_ON_402, false),
